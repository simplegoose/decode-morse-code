...
**[decode morse code ]** is a Ruby application that decodes morse code into readable text.
...
Ensure you have ruby installed in your machine. If you haven't installed ruby visit (https://www.ruby-lang.org/en/downloads/)[Ruby download page]
...
```sh
  cd my-folder
  git clone https://github.com/simplegoose/decode-morse-code.git
```
...
- [Hosting] **[Hosting the application on the cloud]**
